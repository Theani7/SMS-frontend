# Attendance Pulse Heatmap Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Implement a weekly attendance heatmap ("Attendance Pulse") on the Admin Dashboard's Main Stage.

**Architecture:** Create a standalone component `AttendancePulse` that uses mock data to render a heatmap. Integrate this into the `AdminDashboard` within the `DashboardGrid`.

**Tech Stack:** React, Tailwind CSS, shadcn/ui (Card), Lucide React (optional for icon).

---

### Task 1: Create AttendancePulse Component

**Files:**
- Create: `src/features/dashboard/components/attendance-pulse.tsx`

- [ ] **Step 1: Implement the component with mock data and heatmap logic.**
...
git commit -m "feat: implement AttendancePulse heatmap component"
```

---

### Task 2: Integrate AttendancePulse into AdminDashboard

**Files:**
- Modify: `src/features/dashboard/components/admin-dashboard.tsx`

- [ ] **Step 1: Import and add AttendancePulse to DashboardGrid.**
...
- [ ] **Step 1: Run build to ensure no TypeScript or lint errors.**
